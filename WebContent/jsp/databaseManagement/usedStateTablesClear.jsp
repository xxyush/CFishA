...
<%
  ...
  if (tbName == null || tbName.equals("")){
      response.sendRedirect("selectClearTable.jsp");
      return;
  }
%>
  dojo.ready(function(){
...
function clearTable()
{
	 var tbName ="<%=request.getParameter("_tbName")%>";
	 this.location="clearTable.jsp?_tbName="+tbName;
	 
	 // response.sendRedirect("clearTable.jsp?_tbName="+tbName);
};
</script>
...
String tableName = request.getParameter("_tbName");
 %> 
    ...
    <div class="post">
      <div id="gridDiv">
        <div class="gridDivBottom">
          <div id="msg"></div><br/>
         表名：<input type="text" value="<%=tableName%>"/> &nbsp;&nbsp;&nbsp;  
         <input type="button" name="button1" value="确认清除" onclick="clearTable();"/>&nbsp;&nbsp;&nbsp;
         <input type="button" name="button2" value="返回" onclick="window.location.href='selectClearTable.jsp';"/>  
